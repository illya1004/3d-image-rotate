let parent_block = document.getElementById('main-block');
parent_block.style.perspective = `${parent_block.offsetWidth*2}`;
parent_block.style.textAlign = "center";
parent_block.onmouseover = parent_block.onmouseout = parent_block.onmousemove = handler;
...
function handler(event) {
	...
	if (type == "mousemove" || type == "mouseover") {
		let img_cord = parent_block.getBoundingClientRect();
